...
class renrenSpider:   
    ...
    def __init__(self,email,password):
        ...
        try:
            ...
            opener.addheaders = [('123','456')]
            urllib2.install_opener(opener)
            
        print '111111111111111111'
     
    def login(self):
        url='http://www.liuzhuni.com/ajax/UserLogin' 
        postdata = {
                    'account':self.email,
        ...
        for key, value in req.get_headers.items
        	print key, value
